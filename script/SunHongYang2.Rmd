...
# get all fastq name
ls -l RAW/ | grep ^- | awk '{print $9}'

#!/bin/sh -login
#PBS -o /home/xiongyi/sunhongyang/MbPL202011862/cleanFastaq
#PBS -j oe
#PBS -l nodes=1:ppn=24,walltime=999:00:00,mem=120gb
#PBS -N unzip-fastaq
#PBS -q cpu 
cd /home/xiongyi/sunhongyang/MbPL202011862/cleanFastaq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/0nian_clean_R1.fq.gz > T0_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/0nian_clean_R2.fq.gz > T0_2.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/120nian_clean_R1.fq.gz > T120_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/120nian_clean_R2.fq.gz > T120_2.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/2_T_DNA_clean_R1.fq.gz > T2_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/2_T_DNA_clean_R2.fq.gz > T2_2.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/3_T_DNA_clean_R1.fq.gz > T3_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/3_T_DNA_clean_R2.fq.gz > T3_2.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/40nian_clean_R1.fq.gz > T40_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/40nian_clean_R2.fq.gz > T40_2.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/5_T_DNA_clean_R1.fq.gz > T5_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/5_T_DNA_clean_R2.fq.gz > T5_2.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/6_T_DNA_clean_R1.fq.gz > T6_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/6_T_DNA_clean_R2.fq.gz > T6_2.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/8_T_DNA_clean_R1.fq.gz > T8_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/8_T_DNA_clean_R2.fq.gz > T8_2.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/9_T_DNA_clean_R1.fq.gz > T9_1.fastq
gunzip -c /home/xiongyi/sunhongyang/MbPL202011862/RAW/9_T_DNA_clean_R2.fq.gz > T9_2.fastq
...
#!/bin/sh -login
#PBS -o /home/xiongyi/sunhongyang/MbPL202011862/
#PBS -j oe
...
```{bash}
#!/bin/sh -login
#PBS -o /home/xiongyi/sunhongyang/MbPL202011862/INITIAL_BINNING
#PBS -j oe
#PBS -l nodes=1:ppn=24,walltime=999:00:00,mem=120gb
...
```{bash}
#!/bin/sh -login
#PBS -o /home/xiongyi/sunhongyang/MbPL202011862/KRAKENreads
#PBS -j oe
#PBS -l nodes=1:ppn=24,walltime=999:00:00,mem=120gb
...
```{bash}
#!/bin/sh -login
#PBS -o /home/xiongyi/sunhongyang/MbPL202011862/BIN_REFINEMENT
#PBS -j oe
#PBS -l nodes=1:ppn=24,walltime=999:00:00,mem=120gb
...
```{bash}
#!/bin/sh -login
#PBS -o /home/xiongyi/sunhongyang/MbPL202011862/BLOBOLOGY
#PBS -j oe
#PBS -l nodes=1:ppn=24,walltime=999:00:00,mem=120gb
#PBS -N BLOBOLOGY
#PBS -q cpu
...
```{bash}
#!/bin/sh -login
#PBS -o /home/xiongyi/sunhongyang/MbPL202011862/BIN_CLASSIFICATION
#PBS -j oe
#PBS -l nodes=1:ppn=24,walltime=999:00:00,mem=120gb
...
```{bash}
#!/bin/sh -login
#PBS -o /home/xiongyi/sunhongyang/MbPL202011862/FUNCT_ANNOT
#PBS -j oe
#PBS -l nodes=1:ppn=24,walltime=999:00:00,mem=120gb
